...
# res = minimize(lambda coef:fidelity_error(coef),method="powell",x0=np.ones(3)*0.1)
...
# np.savetxt("pxp,z3,2nd_order_perts,3_terms,Hz_eigvalues,"+str(pxp.N),e)
# np.savetxt("pxp,z3,2nd_order_perts,3_terms,Hz_var,"+str(pxp.N),var_vals)
# np.savetxt("pxp,z3,2nd_order_perts,3_terms,Hz_eig_diffs,"+str(pxp.N),e_diff)
