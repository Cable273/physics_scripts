...
# exact_overlap = np.load("./pxp,2nd_order,z2_overlap,"+str(N)+".npy")
# fsa_energy = np.load("./pxp,z2_fsa,2nd_order,e,"+str(N)+".npy")
# fsa_overlap = np.load("./pxp,z2_fsa,2nd_order,z2_overlap,"+str(N)+".npy")
# to_del=[]
# for n in range(0,np.size(exact_overlap,axis=0)):
    # if exact_overlap[n] <tol:
        # to_del = np.append(to_del,n)
...
# f2 = np.load("./pxp,2nd_order,z2_fidelity,"+str(N)+".npy")
...
exact_energy = np.load("./pxp,2nd_order,e,"+str(N)+".npy")
exact_entropy = np.load("./pxp,z2_fsa,2nd_order,entropy,"+str(N)+".npy")
scar_energy = np.load("./pxp,z2_fsa,2nd_order,scar_energy,"+str(N)+".npy")
scar_entropy = np.load("./pxp,z2_fsa,2nd_order,scar_entropy,"+str(N)+".npy")
fsa_energy = np.load("./pxp,z2_fsa,2nd_order,scar_energy,"+str(N)+".npy")
fsa_entropy = np.load("./pxp,z2_fsa,2nd_order,fsa_entropy,"+str(N)+".npy")
