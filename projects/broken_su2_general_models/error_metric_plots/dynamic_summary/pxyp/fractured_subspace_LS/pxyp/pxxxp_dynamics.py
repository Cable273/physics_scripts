...
# Hp[2].uc_size = np.array([4,4,4,4])
# Hp[2].uc_pos = np.array([3,2,2,3])
...
# Hp[3].model = np.array([[0,2,1,0,4,0,1,0],[0,1,0,4,0,1,2,0]])
# Hp[3].model_coef = np.array([1,1])
# Hp[3].uc_size = np.array([4,4])
# Hp[3].uc_pos = np.array([3,2])
...
# Hp[4].model = np.array([[0,1,2,1,2,1,0,2,1,0],[0,1,2,0,1,2,1,2,1,0]])
# Hp[4].model_coef = np.array([1,1])
# Hp[4].uc_size = np.array([4,4])
# Hp[4].uc_pos = np.array([2,1])
...
# Hp[5].model = np.array([[0,2,1,2,0,4,0],[0,4,0,2,1,2,0],[0,1,2,1,0,4,0],[0,4,0,1,2,1,0]])
# Hp[5].model_coef = np.array([1,1,1,1])
# Hp[5].uc_size = np.array([4,4,4,4])
# Hp[5].uc_pos = np.array([0,2,2,0])
...
# Hp[6].model = np.array([[0,1,2,1,0,4,0,0],[0,0,4,0,1,2,1,0],[0,2,1,2,0,4,0,0],[0,0,4,0,2,1,2,0]])
...
# Hp[7].model = np.array([[0,2,0,4,0,2,1,0],[0,2,0,4,0,2,1,0],[0,1,2,0,4,0,2,0],[0,1,2,0,4,0,2,0]])
# Hp[7].model_coef = np.array([1,1,1,1])
# Hp[7].uc_size = np.array([4,4,4,4])
# Hp[7].uc_pos = np.array([0,3,1,2])
