...
np.save("Subcube_basis,"+str(pxp.N),basis)
...
np.save("fsa_basis,"+str(pxp.N),fsa_basis)
...
np.save("perm_basis,"+str(pxp.N),perm_basis)
...
# plt.title(r"$PXP+\lambda (ZPXP+PXPZ)$, Neel overlap, N=16")
plt.title(r"$PXP$, Neel overlap, N=16")
...
# plt.title(r"$PXP+\lambda (ZPXP+PXPZ)$ Exact eig overlap, N=16")
plt.title(r"$PXP$ Exact eig overlap, N=16")
plt.legend()
plt.show()
